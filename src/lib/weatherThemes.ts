...
export const weatherThemes: Record<string, WeatherTheme> = {
  ...
  Drizzle: {
    ...
    icon: `<path d="M8 19v2m8-2v2m-4-5v2M20 17.58A5 5 0 0018 8h-1.26A8 8 0 104 16.25"/>`,
  ...
  Haze: {
    ...
    icon: `<circle cx="12" cy="12" r="10" opacity="0.5"/><path d="M3 15h18M3 9h18"/>`,
    iconColor: 'rgba(250, 250, 249, 0.8)'
  },
  Shower: {
    background: 'linear-gradient(135deg, #0369A1 0%, #075985 50%, #0C4A6E 100%)',
    icon: `<path d="M20 17.58A5 5 0 0018 8h-1.26A8 8 0 104 16.25"/><line x1="8" y1="19" x2="8" y2="21"/><line x1="8" y1="13" x2="8" y2="15"/><line x1="16" y1="19" x2="16" y2="21"/><line x1="16" y1="13" x2="16" y2="15"/><line x1="12" y1="21" x2="12" y2="23"/><line x1="12" y1="15" x2="12" y2="17"/>`,
    iconColor: 'rgba(186, 230, 253, 0.95)'
  },
  Sleet: {
    background: 'linear-gradient(135deg, #67E8F9 0%, #22D3EE 50%, #06B6D4 100%)',
    icon: `<path d="M20 17.58A5 5 0 0018 8h-1.26A8 8 0 104 16.25"/><line x1="8" y1="19" x2="8" y2="21"/><circle cx="16" cy="20" r="1"/><line x1="12" y1="17" x2="12" y2="19"/><circle cx="8" cy="16" r="1"/>`,
    iconColor: 'rgba(8, 51, 68, 0.9)'
  },
  Hail: {
    background: 'linear-gradient(135deg, #E0E7FF 0%, #C7D2FE 50%, #A5B4FC 100%)',
    icon: `<path d="M20 17.58A5 5 0 0018 8h-1.26A8 8 0 104 16.25"/><circle cx="8" cy="19" r="1.5"/><circle cx="13" cy="21" r="1.5"/><circle cx="16" cy="17" r="1.5"/>`,
    iconColor: 'rgba(49, 46, 129, 0.9)'
  },
  Dust: {
    background: 'linear-gradient(135deg, #D97706 0%, #B45309 50%, #92400E 100%)',
    icon: `<path d="M21.5 12h-19M21.5 6h-19M21.5 18h-19"/><circle cx="6" cy="6" r="1"/><circle cx="18" cy="12" r="1"/><circle cx="10" cy="18" r="1"/>`,
